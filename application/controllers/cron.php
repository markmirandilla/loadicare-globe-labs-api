	...
	public function notify_subscribed_recurring()
	{
		...
		if(array_has_value($results))
		{
			...
			foreach($results as $result)
			{
				...
				$message = "LOADICARE: Your donation for {$organization_name} would take effect tomorrow at 12am. Please make sure you have sufficient load balance. Thank you! (free)";
